...
if ( ! defined( 'ABSPATH' ) ) { exit;}
  if( !class_exists( 'Ni_Product_Variations_Dashboard' ) ) {
	class Ni_Product_Variations_Dashboard {
		...
		?>
        <div class="container-fluid" id="niwoopvt">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <div class="card bg-rgba-green-slight">
                            ...
                            <div class="card-body">
                                <h2 class="card-title text-center color-rgba-green-strong">Buy Ni Display Product Variation Table Pro $34.00</h2>
                                ...
                                <div class="text-center">
                                    ...
                                    <a href="http://demo.naziinfotech.com?demo_login=woo_sales_report" class="btn btn-salmon-strong btn-lg" target="_blank">View Demo</a>
                                    <a href="http://naziinfotech.com/?product=ni-woocommerce-sales-report-pro" target="_blank" class="btn btn-salmon-strong btn-lg">Buy Now</a>
                                    <br />
                                    <br />
                                    <br />
                                </div>
            	...
            	<div class="col-md-12">
         			<div class="card">
                      <div class="card-header bg-rgba-salmon-strong">
                        <?php _e('Monitor your sales and grow your online business', 'niwoopvt'); ?>
                      </div>
                      <div class="card-body "> 
                        <div class="row">
            ...
            <div class="row" >
            	<div class="col-md-12">
         			<div class="card">
                      <div class="card-header bg-rgba-salmon-strong">
                        <?php _e('Dashboard - Sales Analysis', 'niwoopvt'); ?>
                      </div>
                      <div class="card-body"> 
                        <div class="row">
                           <div class="col-xl-3 col-md-6 col-lg-4   box10">
							  <div class="card card-border-top card-border-top-box10  shadow p-3 mb-4 bg-white rounded">
                                  <div class="card-body card-body-padding" >
									...
									<h6 class="m-b-20" style="font-size: 14px; text-transform: uppercase"><strong> <?php _e('Total Sales', 'niwoopvt'); ?></strong></h6>
						   ...
						   <div class="col-xl-3 col-md-6 col-lg-4   box1">
							  <div class="card card-border-top card-border-top-box1  shadow p-3 mb-5 bg-white rounded">
                                  <div class="card-body card-body-padding">
                                  	<div class="card-block">
									<h6 class="m-b-20" style="font-size: 14px; text-transform: uppercase"><strong><?php _e('This Year Sales', 'niwoopvt'); ?></strong></h6>
									<p class="text-right"><span>&nbsp;</span></p>
						   ...
						   <div class="col-xl-3 col-md-6 col-lg-4   box4">
							  <div class="card card-border-top card-border-top-box4  shadow p-3 mb-5 bg-white rounded">
                                  <div class="card-body card-body-padding">
                                  	<div class="card-block">
									<h6 class="m-b-20" style="font-size: 14px; text-transform: uppercase"><strong><?php _e('This Month Sales', 'niwoopvt'); ?></strong></h6>
									<p class="text-right"><span>&nbsp;</span></p>
						   ...
						   <div class="col-xl-3 col-md-6 col-lg-4   box6">
							  <div class="card card-border-top card-border-top-box6  shadow p-3 mb-5 bg-white rounded">
                                  <div class="card-body card-body-padding">
                                  	<div class="card-block">
									<h6 class="m-b-20" style="font-size: 14px; text-transform: uppercase"><strong><?php _e('This Week Sales', 'niwoopvt'); ?></strong></h6>
									<p class="text-right"><span>&nbsp;</span></p>
                           ...
                           <div class="col-xl-3 col-md-6 col-lg-4   box8">
							  <div class="card card-border-top card-border-top-box8  shadow p-3 mb-5 bg-white rounded">
                                  <div class="card-body card-body-padding">
                                  	<div class="card-block">
									<h6 class="m-b-20" style="font-size: 14px; text-transform: uppercase"><strong> <?php _e('Yesterday Sales', 'niwoopvt'); ?></strong></h6>
									<p class="text-right"><span>&nbsp;</span></p>
                           ...
                           <div class="col-xl-3 col-md-6 col-lg-4   box10">
							  <div class="card card-border-top card-border-top-box10  shadow p-3 mb-5 bg-white rounded">
                                  <div class="card-body card-body-padding">
                                  	<div class="card-block">
									<h6 class="m-b-20" style="font-size: 14px; text-transform: uppercase"><strong> <?php _e('Total Sales Count', 'niwoopvt'); ?></strong></h6>
									<p class="text-right"><span>&nbsp;</span></p>
						   ...
						   <div class="col-xl-3 col-md-6 col-lg-4   box1">
							  <div class="card card-border-top card-border-top-box1  shadow p-3 mb-5 bg-white rounded">
                                  <div class="card-body card-body-padding">
                                  	<div class="card-block">
									<h6 class="m-b-20" style="font-size: 14px; text-transform: uppercase"><strong><?php _e('This Year Sales Count', 'niwoopvt'); ?></strong></h6>
									<p class="text-right"><span>&nbsp;</span></p>
						   ...
						   <div class="col-xl-3 col-md-6 col-lg-4   box4">
							  <div class="card card-border-top card-border-top-box4  shadow p-3 mb-5 bg-white rounded">
                                  <div class="card-body card-body-padding">
                                  	<div class="card-block">
									<h6 class="m-b-20" style="font-size: 14px; text-transform: uppercase"><strong><?php _e('This Month Sales Count', 'niwoopvt'); ?></strong></h6>
									<p class="text-right"><span>&nbsp;</span></p>
						   ...
						   <div class="col-xl-3 col-md-6 col-lg-4   box6">
							  <div class="card card-border-top card-border-top-box6  shadow p-3 mb-5 bg-white rounded">
                                  <div class="card-body card-body-padding">
                                  	<div class="card-block">
									<h6 class="m-b-20" style="font-size: 14px; text-transform: uppercase"><strong><?php _e('This Week Sales Count', 'niwoopvt'); ?></strong></h6>
									<p class="text-right"><span>&nbsp;</span></p>
                           ...
                           <div class="col-xl-3 col-md-6 col-lg-4   box8">
							  <div class="card card-border-top card-border-top-box8  shadow p-3 mb-5 bg-white rounded">
                                  <div class="card-body card-body-padding">
                                  	<div class="card-block">
									<h6 class="m-b-20" style="font-size: 14px; text-transform: uppercase"><strong> <?php _e('Yesterday Sales Count', 'niwoopvt'); ?></strong></h6>
									<p class="text-right"><span>&nbsp;</span></p>
            ...
            <div class="row" >
            	<div class="col-md-12" >
         			<div class="card">
                      <div class="card-header bg-rgba-salmon-strong">
                        <?php _e('Customer Analysis', 'niwoopvt'); ?> 
                      </div>
                      <div class="card-body "> 
                        <div class="row">
                           <div class="col-xl-3 col-md-6 col-lg-4   box10">
							  <div class="card card-border-top card-border-top-box10  shadow p-3 mb-5 bg-white rounded">
                                  <div class="card-body card-body-padding">
                                  	<div class="card-block">
									<h6 class="m-b-20" style="font-size: 14px; text-transform: uppercase"><strong> <?php _e('Total Customer Count', 'niwoopvt'); ?></strong></h6>
									<p class="text-right"><span>&nbsp;</span></p>
						   ...
						   <div class="col-xl-3 col-md-6 col-lg-4   box1">
							  <div class="card card-border-top card-border-top-box1  shadow p-3 mb-5 bg-white rounded">
                                  <div class="card-body card-body-padding">
                                  	<div class="card-block">
									<h6 class="m-b-20" style="font-size: 14px; text-transform: uppercase"><strong><?php _e('Today Customer Count', 'niwoopvt'); ?></strong></h6>
									<p class="text-right"><span>&nbsp;</span></p>
						   ...
						   <div class="col-xl-3 col-md-6 col-lg-4   box4">
							  <div class="card card-border-top card-border-top-box4  shadow p-3 mb-5 bg-white rounded">
                                  <div class="card-body card-body-padding">
                                  	<div class="card-block">
									<h6 class="m-b-20" style="font-size: 14px; text-transform: uppercase"><strong><?php _e('Total Guest Customer Count', 'niwoopvt'); ?></strong></h6>
									<p class="text-right"><span>&nbsp;</span></p>
						   ...
						   <div class="col-xl-3 col-md-6 col-lg-4   box6">
							  <div class="card card-border-top card-border-top-box6  shadow p-3 mb-5 bg-white rounded">
                                  <div class="card-body card-body-padding">
                                  	<div class="card-block">
									<h6 class="m-b-20" style="font-size: 14px; text-transform: uppercase"><strong><?php _e('Today Guest Cust. Count', 'niwoopvt'); ?></strong></h6>
									<p class="text-right"><span>&nbsp;</span></p>
            ...
            <div class="row" >
            	<div class="col-md-12" >
         			<div class="card">
                      <div class="card-header bg-rgba-salmon-strong">
                       <?php _e('Today  Sales Analysis', 'niwoopvt'); ?>
                      </div>
                      <div class="card-body "> 
                        <div class="row">
                           <div class="col-xl-3 col-md-6 col-lg-4   box10">
							  <div class="card card-border-top card-border-top-box10  shadow p-3 mb-5 bg-white rounded">
                                  <div class="card-body card-body-padding">
                                  	<div class="card-block">
									<h6 class="m-b-20" style="font-size: 14px; text-transform: uppercase"><strong> <?php _e('Today Order Count', 'niwoopvt'); ?></strong></h6>
									<p class="text-right"><span>&nbsp;</span></p>
						   ...
						   <div class="col-xl-3 col-md-6 col-lg-4   box1">
							  <div class="card card-border-top card-border-top-box1  shadow p-3 mb-5 bg-white rounded">
                                  <div class="card-body card-body-padding">
                                  	<div class="card-block">
									<h6 class="m-b-20" style="font-size: 14px; text-transform: uppercase"><strong><?php _e('Today Sales', 'niwoopvt'); ?></strong></h6>
									<p class="text-right"><span>&nbsp;</span></p>
						   ...
						   <div class="col-xl-3 col-md-6 col-lg-4   box4">
							  <div class="card card-border-top card-border-top-box4  shadow p-3 mb-5 bg-white rounded">
                                  <div class="card-body card-body-padding">
                                  	<div class="card-block">
									<h6 class="m-b-20" style="font-size: 14px; text-transform: uppercase"><strong><?php _e('Today Product Sold', 'niwoopvt'); ?></strong></h6>
									<p class="text-right"><span>&nbsp;</span></p>
                           ...
                           <div class="col-xl-3 col-md-6 col-lg-4   box6">
							  <div class="card card-border-top card-border-top-box6  shadow p-3 mb-5 bg-white rounded">
                                  <div class="card-body card-body-padding">
                                  	<div class="card-block">
									<h6 class="m-b-20" style="font-size: 14px; text-transform: uppercase"><strong><?php _e('Today Discount', 'niwoopvt'); ?></strong></h6>
									<p class="text-right"><span>&nbsp;</span></p>
                           ...
                           <div class="col-xl-3 col-md-6 col-lg-4   box6">
							  <div class="card card-border-top card-border-top-box6  shadow p-3 mb-5 bg-white rounded">
                                  <div class="card-body card-body-padding">
                                  	<div class="card-block">
									<h6 class="m-b-20" style="font-size: 14px; text-transform: uppercase"><strong><?php _e('Today Tax', 'niwoopvt'); ?></strong></h6>
									<p class="text-right"><span>&nbsp;</span></p>
            ...
            <div class="row" >
            	<div class="col-md-12" >
         			<div class="card">
                      <div class="card-header bg-rgba-salmon-strong">
                      <?php _e('Stock Analysis', 'niwoopvt'); ?>
                      </div>
                      <div class="card-body "> 
                        <div class="row">
                           <div class="col-xl-3 col-md-6 col-lg-4   box10">
							  <div class="card card-border-top card-border-top-box10  shadow p-3 mb-5 bg-white rounded">
                                  <div class="card-body card-body-padding">
                                  	<div class="card-block">
									<h6 class="m-b-20" style="font-size: 14px; text-transform: uppercase"><strong> <?php _e('Low in stock', 'niwoopvt'); ?></strong></h6>
									<p class="text-right"><span>&nbsp;</span></p>
						   ...
						   <div class="col-xl-3 col-md-6 col-lg-4   box1">
							  <div class="card card-border-top card-border-top-box1  shadow p-3 mb-5 bg-white rounded">
                                  <div class="card-body card-body-padding">
                                  	<div class="card-block">
									<h6 class="m-b-20" style="font-size: 14px; text-transform: uppercase"><strong><?php _e('Out of stock', 'niwoopvt'); ?></strong></h6>
									<p class="text-right"><span>&nbsp;</span></p>
						   ...
						   <div class="col-xl-3 col-md-6 col-lg-4   box4">
							  <div class="card card-border-top card-border-top-box4  shadow p-3 mb-5 bg-white rounded">
                                  <div class="card-body card-body-padding">
                                  	<div class="card-block">
									<h6 class="m-b-20" style="font-size: 14px; text-transform: uppercase"><strong><?php _e('Most Stocked', 'niwoopvt'); ?></strong></h6>
									<p class="text-right"><span>&nbsp;</span></p>
            ...
            <div class="row" >
            	<div class="col-md-12">
         			<div class="card">
                      <div class="card-header bg-rgba-salmon-strong">
                     <?php _e( 'recent orders', 'niwoopvt'); ?>
                      </div>
                      <div class="card-body "> 
                        <div class="row">
                        	<div class="table-responsive niwoopvt-table">
                            	<table class="table table-striped table-hover">
                    	 <thead class="shadow-sm p-3 mb-5 bg-white rounded">
                        	<tr>
                           <th><?php _e( 'Order ID', 'niwoopvt'); ?></th>
                            <th><?php _e( 'Order Date', 'niwoopvt'); ?> </th>
                            <th><?php _e( 'First Name', 'niwoopvt'); ?> </th>
                            <th><?php _e( 'Billing Email', 'niwoopvt'); ?></th>
                            <th><?php _e( 'Country', 'niwoopvt'); ?> </th>
                            <th><?php _e( 'Order Status', 'niwoopvt'); ?>  </th>
                            <th><?php _e( 'Currency', 'niwoopvt'); ?> </th>
                            <th class="text-right"><?php _e( 'Order Total', 'niwoopvt'); ?>  </th>
						</tr>
                        </thead>
                        ...
                        <div class="row">
                            ...
                            <div class="table-responsive niwoopvt-table">
                        	 ...
                        	 <thead class="shadow-sm p-3 mb-5 bg-white rounded">
                            	<tr>
                                <th><?php _e('Order Status', 'niwoopvt'); ?></th>
                                <th><?php _e('Order Count', 'niwoopvt'); ?></th>
                                <th><?php _e('Order Total', 'niwoopvt'); ?></th>
                            	</tr>
                            </thead>
            ...
            <div class="row" >
            	<div class="col-md-12" >
         			<div class="card">
                      <div class="card-header bg-rgba-salmon-strong">
                    <?php _e('payment gateway', 'niwoopvt'); ?>
                      </div>
                      <div class="card-body "> 
                        <div class="row">
                        	<div class="col-sm-6 col-md-6 col-lg-6">
                            <div class="table-responsive niwoopvt-table">
                        	 ...
                        	 <thead class="shadow-sm p-3 mb-5 bg-white rounded">
                            	<tr>
                                <th><?php _e( 'Payment Method', 'niwoopvt'); ?> </th>
                                <th><?php _e( 'Order Count', 'niwoopvt'); ?></th>
                                <th><?php _e( 'Order Total', 'niwoopvt'); ?></th>
                            </tr>
                            </thead>
            ...
            <div class="row" >
            	<div class="col-md-6"  >
         			<div class="card">
                      <div class="card-header bg-rgba-salmon-strong">
                    <?php _e('Top 5 Customer Report', 'niwoopvt'); ?>
                      </div>
                      <div class="card-body "> 
                        <div class="row">
                            ...
                            <div class="table-responsive niwoopvt-table">
                        	 ...
                        	 <thead class="shadow-sm p-3 mb-5 bg-white rounded">
                            	<tr>
                                <th><?php _e('First Name', 'niwoopvt'); ?>  </th>
                                <th><?php _e('Email Address', 'niwoopvt'); ?></th>
                                <th><?php _e('Order Count', 'niwoopvt'); ?></th>
                                <th><?php _e('Order Total', 'niwoopvt'); ?></th>
                            </tr>
                            </thead>
							...
							?>
                            <tr>
                            	<td colspan="4"><?php _e('No Customer found', 'niwoopvt'); ?></td>
                            </tr>
                            <?php
							} 
							 ?>
                ...
                <div class="col-md-6" >
         			<div class="card">
                      <div class="card-header bg-rgba-salmon-strong">
                  <?php _e('TOP 5 Country REPORT', 'niwoopvt'); ?> 
                      </div>
                      <div class="card-body "> 
                        <div class="row">
                        	<div class="col-sm-12 col-md-12 col-lg-12">
